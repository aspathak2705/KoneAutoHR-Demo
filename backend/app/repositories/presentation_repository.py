...
class PresentationRepository:
    ...
    def create(self, db: DBSession, name: str, original_filename: str, storage_path: str, file_hash: Optional[str] = None, uploaded_by: Optional[str] = None, **kwargs) -> Presentation:
        db_obj = Presentation(
            name=name,
