...
class RuntimeSessionManager:
    ...
    def can_transition(self, target_state: RuntimeState) -> bool:
        ...
        valid_transitions = {
            ...
            RuntimeState.READY: [RuntimeState.STARTING, RuntimeState.FAILED],
            RuntimeState.STARTING: [RuntimeState.BROWSER_READY, RuntimeState.FAILED],
            RuntimeState.BROWSER_READY: [RuntimeState.JOINING, RuntimeState.FAILED],
            RuntimeState.JOINING: [RuntimeState.WAITING, RuntimeState.FAILED],
            RuntimeState.WAITING: [RuntimeState.CONNECTED, RuntimeState.FAILED],
            RuntimeState.CONNECTED: [RuntimeState.PRESENTING, RuntimeState.FAILED],
